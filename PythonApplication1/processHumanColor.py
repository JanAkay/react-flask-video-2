...
def process_human(video_path, object_classes, use_gpu, color):
    ...
    out_all = cv2.VideoWriter("static/output_video_with_boxes_all.mp4", fourcc, fps, (width, height))
    out_class = cv2.VideoWriter(f"static/output_video_with_boxes_classes.mp4", fourcc, fps, (width, height))
    ...
    return {
        "all": "static/output_video_with_boxes_all.mp4",
        "classes": "static/output_video_with_boxes_classes.mp4"
    }
